...
Personal website and blog for Matt Rosenberg. Built with [Jekyll](https://jekyllrb.com/), written in [Obsidian](https://obsidian.md/), deployed via [Netlify](https://www.netlify.com/), and managed with [Decap CMS](https://decapcms.org/).
